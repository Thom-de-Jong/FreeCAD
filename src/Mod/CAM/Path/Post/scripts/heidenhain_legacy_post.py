...
TOOLTIP = """
This is a legacy postprocessor file for the Path workbench. It is used to
...
import heidenhain_legacy_post
heidenhain_legacy_post.export(object,"/path/to/file.ncc","")
"""
